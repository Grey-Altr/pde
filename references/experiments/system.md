...
Mutations stay within `<!-- OPTIMIZABLE -->` markers. Fixture measures contrast compliance on reference HTML. For live measurement, update verify to `node bin/contrast-metric.cjs .planning/design/visual/SYS-preview-v1.html`.
