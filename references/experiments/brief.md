...
Mutations stay within `<!-- OPTIMIZABLE -->` markers. Fixture measures DOM structure as proxy for downstream wireframe quality. Full brief-to-wireframe pipeline measurement is a Phase 113 concern. For live measurement, update verify to point to actual wireframe output.
