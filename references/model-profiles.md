...
|-------|-----------|------------|----------|------------|-----------|
| pde-planner | opus | opus | sonnet | opus | inherit |
| pde-roadmapper | opus | sonnet | sonnet | sonnet | inherit |
| pde-executor | opus | sonnet | sonnet | sonnet | inherit |
| pde-phase-researcher | opus | sonnet | haiku | sonnet | inherit |
| pde-project-researcher | opus | sonnet | haiku | sonnet | inherit |
| pde-research-synthesizer | sonnet | sonnet | haiku | haiku | inherit |
| pde-debugger | opus | sonnet | sonnet | opus | inherit |
| pde-codebase-mapper | sonnet | haiku | haiku | haiku | inherit |
| pde-verifier | sonnet | sonnet | haiku | sonnet | inherit |
| pde-plan-checker | sonnet | sonnet | haiku | haiku | inherit |
| pde-integration-checker | sonnet | sonnet | haiku | haiku | inherit |
| pde-nyquist-auditor | sonnet | sonnet | haiku | haiku | inherit |
...
```json
{
  ...
  "model_overrides": {
    "pde-planner": "o3",
    "pde-executor": "o4-mini",
    "pde-debugger": "o3",
    "pde-codebase-mapper": "o4-mini"
  }
}
```
