...
|----------|---------------|---------------|-------|
| plan-phase | pde-planner | pde-plan-checker | Revision prompt via planner-revision.md |
| execute-phase | pde-executor | pde-verifier | Post-execution verification |
| discuss-phase | orchestrator | pde-plan-checker | Inline revision by orchestrator |
