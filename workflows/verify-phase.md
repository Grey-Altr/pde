...
<required_reading>
@$HOME/.claude/pde-os/engines/gsd/references/verification-patterns.md
@$HOME/.claude/pde-os/engines/gsd/templates/verification-report.md
</required_reading>
...
```bash
node "$HOME/.claude/pde-os/engines/gsd/bin/gsd-tools.cjs" roadmap analyze
```
...
See $HOME/.claude/pde-os/engines/gsd/templates/verification-report.md for complete template.
</step>
