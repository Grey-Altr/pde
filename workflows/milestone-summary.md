...
4. If nothing found: error "No milestone found. Run /pde:new-project or /pde:new-milestone first."
...
If the user is done:
- Suggest next steps: `/pde:new-milestone`, `/pde:progress`, or sharing the summary with the team
