<purpose>
Switch the model profile used by PDE agents. Controls which Claude model each agent uses, balancing quality vs token spend.
</purpose>
...
[Show table from MODEL_PROFILES in pde-tools.cjs for selected profile]
