...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to `/pde:discuss-phase`.
...
Consider running /pde:discuss-phase {N} again to refine before planning.
```
