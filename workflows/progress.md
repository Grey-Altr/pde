...
Run /pde:new-project to start a new project.
```

Exit.

If missing STATE.md: suggest `/pde:new-project`.

**If ROADMAP.md missing but PROJECT.md exists:**

This means a milestone was completed and archived. Go to **Route F** (between milestones).

If missing both ROADMAP.md and PROJECT.md: suggest `/pde:new-project`.
</step>
...
## Pending Todos
- [count] pending — /pde:check-todos to review

## Active Debug Sessions
- [count] active — /pde:debug to continue
