...
See $HOME/.claude/pde-os/engines/gsd/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using $HOME/.claude/pde-os/engines/gsd/templates/discovery.md structure:
...
1. **Scope the discovery** using $HOME/.claude/pde-os/engines/gsd/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from $HOME/.claude/pde-os/engines/gsd/templates/discovery.md
...
Use $HOME/.claude/pde-os/engines/gsd/templates/discovery.md.
