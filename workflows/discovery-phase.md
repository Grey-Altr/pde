...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /pde:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See /Users/greyaltaer/.claude/pde-os/engines/gsd/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Users/greyaltaer/.claude/pde-os/engines/gsd/templates/discovery.md structure:
...
1. **Scope the discovery** using /Users/greyaltaer/.claude/pde-os/engines/gsd/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Users/greyaltaer/.claude/pde-os/engines/gsd/templates/discovery.md
...
Use /Users/greyaltaer/.claude/pde-os/engines/gsd/templates/discovery.md.
...
1. Discuss phase context (/pde:discuss-phase [current-phase])
2. Create phase plan (/pde:plan-phase [current-phase])
