...
See ${CLAUDE_PLUGIN_ROOT}/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ${CLAUDE_PLUGIN_ROOT}/templates/discovery.md structure:
...
1. **Scope the discovery** using ${CLAUDE_PLUGIN_ROOT}/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ${CLAUDE_PLUGIN_ROOT}/templates/discovery.md
...
Use ${CLAUDE_PLUGIN_ROOT}/templates/discovery.md.
