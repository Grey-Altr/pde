...
Parse the JSON result. Extract all 20 flags. Default any absent flag to `false`:
...
Then write the FULL 20-field JSON, setting `hasMockup` to `true` and passing all other flags through unchanged:
