...
Parse the JSON result. Extract all 21 flags. Default any absent flag to `false`:
...
Then write the FULL 21-field JSON, setting `hasMockup` to `true` and passing all other flags through unchanged:
