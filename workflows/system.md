...
The FULL INLINE COPY of all CSS custom property declarations from files 2-8. This file MUST NOT use `@import`. It must work standalone when opened as a `file://` URL (no external fetches).

```css
/* tokens.css — Unified Design Token File */
/* Generated by /pde:system | {ISO date} */
/* All tokens are inlined. No @import. Works as a standalone file:// stylesheet. */

/* ============================================================
   COLOR TOKENS
   ============================================================ */

/* [full content of SYS-colors.css pasted inline] */

/* ============================================================
   TYPOGRAPHY TOKENS
   ============================================================ */

/* [full content of SYS-typography.css pasted inline] */

/* ============================================================
   SPACING TOKENS
   ============================================================ */

/* [full content of SYS-spacing.css pasted inline] */

/* ============================================================
   SHADOW TOKENS
   ============================================================ */

/* [full content of SYS-shadows.css pasted inline] */

/* ============================================================
   BORDER TOKENS
   ============================================================ */

/* [full content of SYS-borders.css pasted inline] */

/* ============================================================
   MOTION TOKENS
   ============================================================ */

/* [full content of SYS-motion.css pasted inline] */

/* ============================================================
   COMPONENT STYLES
   ============================================================ */

/* [full content of SYS-components.css pasted inline] */
```

Note: Include utility classes (SYS-utilities.css) inline as well in a UTILITY CLASSES section.
