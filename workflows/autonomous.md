...
**If `roadmap_exists` is false:** Error — "No ROADMAP.md found. Run `/pde:new-milestone` first."
**If `state_exists` is false:** Error — "No STATE.md found. Run `/pde:new-milestone` first."
...
```
Skill(skill="pde-ui-phase", args="${PHASE_NUM}")
```
...
```
Skill(skill="pde-ui-review", args="${PHASE_NUM}")
```
...
> **Note:** Smart discuss is an autonomous-optimized variant of the `pde-discuss-phase` skill. It produces identical CONTEXT.md output but uses batch table proposals instead of sequential questioning. The original `pde-discuss-phase` skill remains unchanged (per CTRL-03). Future milestones may extract this to a separate skill file.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 Resume with: /pde:autonomous --from ${next_incomplete_phase}
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 Lifecycle skipped — run /pde:autonomous without --only
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 Resume with: /pde:autonomous ${ONLY_PHASE ? "--only " + ONLY_PHASE : "--from " + next_phase}${TO_PHASE ? " --to " + TO_PHASE : ""}
```
