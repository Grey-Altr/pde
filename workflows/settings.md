...
AskUserQuestion([
  ...
  {
    question: "Enable UI Safety Gate? (prompts to run /pde:ui-phase before planning frontend phases)",
    header: "UI Gate",
    multiSelect: false,
    options: [
      { label: "Yes (Recommended)", description: "plan-phase asks to run /pde:ui-phase first when frontend indicators detected." },
...
Quick commands:
- /pde:set-profile <profile> — switch model profile
