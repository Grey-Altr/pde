...
```bash
node "$HOME/.claude/pde-os/engines/gsd/bin/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "$HOME/.claude/pde-os/engines/gsd/bin/gsd-tools.cjs" validate health
```
