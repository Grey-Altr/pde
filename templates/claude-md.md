...
**Fallback text:**
```
Project not yet initialized. Run /pde:new-project to set up.
```
...
- `/pde:quick` for small fixes, doc updates, and ad-hoc tasks
- `/pde:debug` for investigation and bug fixing
- `/pde:execute-phase` for planned phase work
...
> Profile not yet configured. Run `/pde:profile-user` to generate your developer profile.
