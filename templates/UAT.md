...
- This section feeds directly into /pde:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /pde:plan-phase --gaps with root causes
...
**Creation:** When /pde:verify-work starts new session
...
- `/pde:verify-work {phase}` picks up from first pending/blocked test
