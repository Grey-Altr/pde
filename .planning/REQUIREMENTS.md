...
- [x] **RVAL-03**: Research validator produces RESEARCH-VALIDATION.md with three-state output per claim (VERIFIED / UNVERIFIABLE / CONTRADICTED)
...
- [x] **DEBT-02**: TRACKING-PLAN.md — create file or remove broken reference from consent panel
...
- [x] **DEBT-05**: SUMMARY.md `one_liner` field — add field to template and backfill recent phase SUMMARY.md files
