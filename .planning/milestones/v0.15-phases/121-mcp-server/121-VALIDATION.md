...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 121-01-01 | 01 | 1 | MCP-01 | unit | `node --test tests/phase-121/test-mcp-server.cjs` | yes | ✅ green |
| 121-01-02 | 01 | 1 | MCP-02 | unit | `node --test tests/phase-121/test-mcp-server.cjs` | yes | ✅ green |
| 121-01-03 | 01 | 1 | MCP-03 | unit | `node --test tests/phase-121/test-mcp-server.cjs` | yes | ✅ green |
| 121-01-04 | 01 | 1 | MCP-04 | unit | `node --test tests/phase-121/test-mcp-server.cjs` | yes | ✅ green |
| 121-01-05 | 01 | 1 | MCP-05 | unit | `node --test tests/phase-121/test-mcp-server.cjs` | yes | ✅ green |
...
- [x] `tests/phase-121/test-mcp-server.cjs` — stubs for MCP-01 through MCP-05
- [x] `packages/pde-mcp-server/` — package directory with package.json
