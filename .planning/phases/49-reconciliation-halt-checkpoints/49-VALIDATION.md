...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 49-01-01 | 01 | 1 | VRFY-01 | unit (grep) | `grep -n "reconcile_phase" workflows/execute-phase.md` | W0 | pending |
| 49-01-02 | 01 | 1 | VRFY-01 | unit (file) | `test -f workflows/reconcile-phase.md` | W0 | pending |
| 49-01-03 | 01 | 1 | VRFY-02 | unit | `node --test tests/phase-49/reconciliation.test.mjs` | W0 | pending |
| 49-02-01 | 02 | 1 | VRFY-05 | unit | `node --test tests/phase-49/halt-risk-tagging.test.mjs` | W0 | pending |
| 49-02-02 | 02 | 1 | VRFY-05 | unit (grep) | `grep -n "MANDATORY HALT" workflows/execute-plan.md` | W0 | pending |
| 49-REG | — | — | PLAN-01,04 | regression | `node --test tests/phase-48/*.test.mjs` | Existing | pending |
...
- [ ] `tests/phase-49/reconciliation.test.mjs` — slug matching, file overlap fallback, unplanned detection, incomplete status
- [ ] `tests/phase-49/halt-risk-tagging.test.mjs` — risk attribute extraction, risk header in task files, risk_reason propagation
